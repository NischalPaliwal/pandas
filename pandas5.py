...
# interpolate function works only with numerical values
# nocs['notes'] = nocs['notes'].interpolate()
# print(nocs.head())

new_nocs = nocs.dropna(subset=['notes'], inplace=False).copy()
print(new_nocs)

print(nocs[nocs['notes'].notna()])